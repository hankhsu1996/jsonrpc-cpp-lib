...
/**
 * @brief Calculator Client Example using Framed Pipe Transport
 *
 * This is a simple demonstration of a JSON-RPC client using framed pipe
 * transport. The example shows how to connect to a server, make method calls,
